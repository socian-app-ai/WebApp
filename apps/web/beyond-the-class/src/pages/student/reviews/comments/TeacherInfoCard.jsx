...
export default function TeacherInfoCard() {
    ...
    return (
        <Box className="bg-gray-100 dark:bg-[#222222] min-h-[30rem] max-h-[auto] rounded-lg shadow-lg  mt-10  pt-3  m-2 lg:sticky lg:top-7 ">
                ...
                <div className="flex flex-row sm:flex-row lg:flex-col p-4 xl:flex-row">
                    ...
                    <div className="ml-2 lg:ml-0 xl:ml-2">
                        ...
                        {teacher && teacher?.campus && (
                            <p>Location: {teacher.campus.location}</p>
                        )}
                    </div>
                </div>
                <div className="p-2">
